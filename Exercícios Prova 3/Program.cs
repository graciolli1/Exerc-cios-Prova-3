...
namespace Exercícios_Prova_3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int fig;
            Console.WriteLine("Escolha a figura: [1] Círculo [2] Losango [3] Trapézio");
            ...
            switch (fig)
            {
                ...
                case 2:
                    ...
                    Console.WriteLine("A área do losango é: " + dMiaMaior * diaMenor / 2);
                    break;
                case 3:
